...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("UsingSWFAssets", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("UsingSWFAssets", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "UsingSWFAssets";
		app.meta["name"] = "Using SWF Assets";
		app.meta["packageName"] = "org.openfl.tutorials.usingswfassets";
